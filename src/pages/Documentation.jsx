  ...
  return (
    <PageTransition className="max-w-4xl mx-auto px-4 py-16 space-y-8">
      <div className="space-y-4">
        ...
        <h1 className="text-4xl md:text-5xl font-display font-bold text-on-surface tracking-tight">TradePad Documentation</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 space-y-4">
          <div className="glass-card p-5 rounded-2xl border-outline-variant space-y-4 md:sticky md:top-24">
            <h3 className="font-display font-bold text-on-surface text-sm uppercase tracking-wider">Sections</h3>
            <nav className="flex flex-row flex-wrap md:flex-col gap-2 md:gap-2.5 text-xs">
              <a href="#introduction" className="text-on-surface-variant hover:text-on-surface transition-colors">Introduction</a>
              <a href="#how-it-works" className="text-on-surface-variant hover:text-on-surface transition-colors">How it Works</a>
              <a href="#premium-benefits" className="text-on-surface-variant hover:text-on-surface transition-colors">Premium Benefits</a>
              <a href="#whitelist-group" className="text-on-surface-variant hover:text-on-surface transition-colors">Join Whitelists</a>
              <a href="#transparency-proof" className="text-on-surface-variant hover:text-on-surface transition-colors">Vetting & DexScreener</a>
            </nav>
          </div>
        </div>
        ...
        <div className="md:col-span-2 space-y-12 text-on-surface-variant leading-relaxed text-sm">
          ...
          <section id="introduction" className="space-y-4">
            <h2 className="text-2xl text-on-surface font-bold font-display border-b border-outline-variant pb-2">Introduction</h2>
            <p>
          ...
          <section id="how-it-works" className="space-y-4">
            <h2 className="text-2xl text-on-surface font-bold font-display border-b border-outline-variant pb-2">How it Works</h2>
            <p>
          ...
          <section id="premium-benefits" className="space-y-4">
            <h2 className="text-2xl text-on-surface font-bold font-display border-b border-outline-variant pb-2">Premium Benefits</h2>
            <p>
          ...
          <section id="whitelist-group" className="space-y-4">
            <h2 className="text-2xl text-on-surface font-bold font-display border-b border-outline-variant pb-2">Join Whitelists</h2>
            <p>
          ...
          <section id="transparency-proof" className="space-y-4">
            <h2 className="text-2xl text-on-surface font-bold font-display border-b border-outline-variant pb-2">Vetting & DexScreener</h2>
            <p>
